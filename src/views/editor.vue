<template>
  <div
    class="m-auto max-w-6xl flex flex-col justify-center items-center bg-blue-200"
  >
    ...
    <div class="flex w-full bg-gray-50 mt-5">
      <div class="w-1/2 p-3">
        <textarea
          ...
          :value="canvasControls.selectedObjects.value.toString()"
        ></textarea>
      </div>
      <div class="w-1/2 p-3">
...
onMounted(() => {
  canvasControls.init(canvasElRef, 1920, 1080);
});
